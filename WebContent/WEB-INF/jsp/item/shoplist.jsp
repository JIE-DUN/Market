...
<div class="width1198 center_yh" style="height: 35px;background: #f0f0f0; border: 1px solid #ddd;margin-top:25px;">
    ...
    <a href="${ctx}/item/shoplist?price=1&condition=${condition}&categoryIdTwo=${obj.categoryIdTwo}" class="mR">
        价格
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
    <a href="${ctx}/item/shoplist?gmNum=1&condition=${condition}&categoryIdTwo=${obj.categoryIdTwo}" class="mR">
        销量
        <img src="${ctx}/resource/user/images/gg.png" alt="">
    </a>
    ...
    <ul class="listSs">
        <c:forEach items="${pagers.datas}" var="data" varStatus="l">
            <li>
                ...
                <div class="wCa">
                    <a href="${ctx}/user/sc/exAdd?itemId=${data.id}" class="fav">
                        <div class="wCa1">
...
<script>
    function addcar(id) {
        $.ajax({
            type:"POST",
            url:"${ctx}/user/car/exAdd?itemId="+id+"&num=1",
            success:function (result) {
                ...
                if(re.res == 0){
                    ...
                    window.location.href="${ctx}/user/car/findUserCar";
                }
            }
        });
    }
