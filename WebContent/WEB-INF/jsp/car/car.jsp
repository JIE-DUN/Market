...
<div class="width1200 hidden_yh center_yh font20">全部商品<font class="red">(${pagers.total})</font> </div>
...
<div id="navs">
	<div class="pagelist">
	  <!--分页开始-->
	  <pg:pager url="${ctx}/user/car/findUserCar" maxIndexPages="5" items="${pagers.total}" maxPageItems="15" export="curPage=pageNumber">
	      <pg:last>
