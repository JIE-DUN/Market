...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/user/itemOrder/my" class="on">我的订单</a>
            <a href="${ctx}/user/sc/findAllSc">商品收藏</a>
            <a href="${ctx}/user/login/pass">修改密码</a>
        </div>
        <div id="vipRight">
                        ...
                        <div class="width100 hidden_yh">
                                ...
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="right_yh">
                                        <c:if test="${data.status==3}">
                                            <a href="${ctx}/user/itemOrder/pj?id=${chil.itemId}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top: 10px;padding-right: 6px;">
                                                去评价
                                            </a>
                                        </c:if>
                                    </div>
                            ...
                            <div style="width: 838px;padding-top:30px;padding-bottom: 30px;" class="hidden_yh center_yh tleft">
                                ...
                                <c:if test="${data.status==0}">
                                    <a href="${ctx}/user/itemOrder/qx?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        取消订单
                                    </a>
                                </c:if>
                                ...
                                <c:if test="${data.status==2}">
                                    <a href="${ctx}/user/itemOrder/sh?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        去收货
                                    </a>
                                </c:if>
                                <c:if test="${data.status==3}">
