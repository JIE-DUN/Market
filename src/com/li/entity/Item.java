...
public class Item implements Serializable{
    ...
    private ItemCategoryOne yiji;

    /** 类别id二级 */
    private Integer categoryIdTwo;

    private ItemCategoryTwo erji;
    ...
    public Item(Integer id, String name, String price, Integer zk, Integer scNum, Integer gmNum, String url1,
			String url2, String url3, String url4, String url5, String ms, String pam1, String pam2, String pam3,
			String val1, String val2, String val3, Integer type, Integer categoryIdOne, ItemCategoryOne yiji,
			Integer categoryIdTwo, ItemCategoryTwo erji, List<Comment> pls) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
    ...
    public ItemCategoryOne getYiji() {
        return yiji;
    }

    public void setYiji(ItemCategoryOne yiji) {
        this.yiji = yiji;
    }
    ...
    public ItemCategoryTwo getErji() {
        return erji;
    }

    public void setErji(ItemCategoryTwo erji) {
        this.erji = erji;
    }
	...
	public String toString() {
		return "Item [id=" + id + ", name=" + name + ", price=" + price + ", zk=" + zk + ", scNum=" + scNum + ", gmNum="
				...
				+ ", categoryIdTwo=" + categoryIdTwo + ", erji=" + erji + ", pls=" + pls + "]";
	}
